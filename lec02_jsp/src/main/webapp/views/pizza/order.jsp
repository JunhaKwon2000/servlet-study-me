...
<body>
	...
	<form name="orderFrm" id="orderFrm" action="/pizzaOrderEnd" method="post">
	  ...
	  <fieldset>
	      <legend>토핑 선택</legend>
	      <input type="checkbox" id="shrimp" value="1" name="pizza_toppings">
	      <label for="shrimp">새우</label>
	      <br>
	      <input type="checkbox" id="sweet" value="2" name="pizza_toppings">
	      <label for="sweet">고구마</label>
	      <br>
	      <input type="checkbox" id="potato" value="3" name="pizza_toppings">
	      <label for="potato">감자</label>
	      <br>
	      <input type="checkbox" id="pine" value="4" name="pizza_toppings">
